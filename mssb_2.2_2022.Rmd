...
```{r organize plate readings, echo=TRUE, message=FALSE}
...
```{r plot plate readings, echo=TRUE, message=FALSE}
...
```{r growth curve comparison, echo=TRUE}
...
Stat observed value of the statistic P.Value estimated p-value adj.P.Value p-value adjusted for multiple testing

```{r growth curve fluorescent protein, echo=TRUE}
...
Finally we explore the limits of detection given our experimental setup.
```{r limits of detection, echo=TRUE}
